...
export default function Register() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 py-12">
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 w-full max-w-md mx-4 border border-white/20 shadow-luxury-xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Join CreatorHub</h1>
            <p className="text-gray-300">Start your creator journey today</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-transparent text-gray-300">Or create account with email</span>
            </div>
          </div>
              ...
              <div className="flex space-x-4">
                <label className="flex items-center cursor-pointer">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`px-4 py-2 rounded-lg border transition-all ${!isCreator
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-400">
              ...
              <Link href="/legal/terms" className="text-purple-400 hover:text-purple-300">Terms of Service</Link>
              {' '}and{' '}
              <Link href="/legal/privacy" className="text-purple-400 hover:text-purple-300">Privacy Policy</Link>
            </p>
          </div>
        </div>
      </div>
